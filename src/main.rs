...
impl Api {
	...
	async fn add_group_member(&self, database: Data<&Database>, group_id: Path<String>, user_id: PlainText<String>) -> Json<Group> {
		let collection = database.collection::<Group>("groups");
	...
	#[oai(path = "/groups/:group_id/expenses", method = "post")]
